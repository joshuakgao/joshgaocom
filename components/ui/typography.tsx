...
export const H0 = createComponent<HTMLHeadingElement>(
  "h1",
  "scroll-m-20 text-3xl md:text-5xl font-medium text-gray-800",
  "H0",
);

export const H1 = createComponent<HTMLHeadingElement>(
  "h1",
  "scroll-m-20 text-2xl md:text-3xl font-medium text-gray-800",
  "H1",
);

export const H2 = createComponent<HTMLHeadingElement>(
  "h2",
  "scroll-m-20 text-xl font-medium text-gray-600",
  "H2",
);
