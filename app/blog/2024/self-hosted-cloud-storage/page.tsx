...
export default function SelfHostedCloud() {
  ...
  return (
    <PostWrapper post={post}>
      <PostContent>
        <P>
          Have you run out of storage in your Google Drive? Do you not want to
          pay the pricy subscription fee just to save your photos? Try self
          hosting Nextcloud as your cloud storage solution!
        </P>
        <P className="italic">
        ...
        <P>
          ...
          box, and requires some sort of Pi hat for this to work. That's where
        ...
        <P>
          ...
          But despite all the good points .my girlfriend made about saving
          money, LOOK HOW COOL IT LOOKS 🤩. Between the finished aluminum case,
          the acrylic panels, LED lights, industrial looking heat sink, and the
          mini display, it was $79 dollars well spent.
        </P>
        <P>
          Other than the price, the only real downside of the case is that it
          acts like a faraday cage with all the metal surrounding the wifi
          module on the Pi itself. I 100% recommend buying a USB wifi dongle, or
          ideally just have a wired LAN connection.
        </P>
        <H1>Nextcloud</H1>
        <P>
      ...
      <PostContent>
        ...
        <P>
          ...
          <InlineCode>https://your.domainnamehere.com</InlineCode>. Finally
        ...
        <P>
          Ngrok is $10 a month, which I know, totally defeats the purpose of
          this project. But it's still cheaper than cloud storage, and you can
          scale it to as many TB's as you want.
        </P>
        <P>
        ...
        <P>
          This all does seem pricey for something that was meant to save money.
          I went for the cool factor which is absolutely not necessary. You can
          skip the Pironman 5 Case for a pi hat and a cheap RaspberryPi case, or
          even just skip the case all together. This would bring your cost down
          around ~$70.
        </P>
        <P>
          You could also get an older Pi and just hook it up to a regular SSD
          with an adapter. Not only can you get Raspberry Pi 4 for just $35, but
          also non-NVMe SSDs are much cheaper than their NVMe counter parts.
        </P>
        <P>
          Additionally, you can skip the Ngrok subscription if you figure out
          how to use Nginx. I never really figured out how it works, and Ngrok
          made it really easy and saved me a ton of time.
        </P>
        <P>
        ...
        <H1>Conclusion</H1>
        <P>
          Self-hosting your own cloud storage with Nextcloud is not only a fun
          and rewarding project—it also gives you full control over your data,
          removes reliance on big tech subscriptions, and can be surprisingly
          affordable if you go the budget route. Whether you're doing it for
          privacy, cost savings, or just the satisfaction of building your own
          infrastructure, setting up a Raspberry Pi-powered cloud server is a
          fantastic step toward digital independence. Happy hosting!
        </P>
      </PostContent>
    </PostWrapper>
  );
