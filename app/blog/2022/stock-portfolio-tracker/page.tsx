    ...
    <PostWrapper post={post}>
      <PostContent>
        <P>
          ...
          benchmarking agains the S&P 500, portoflio overview, and even tracks
          the trades of the biggest investors in the world. Let me give you a
          tour!
        </P>
        <P>
          If you are interested in using this tracker, you can create a
          duplicate{" "}
          <PostLink href="https://docs.google.com/spreadsheets/d/1wrPfNQtEmuMB3GUdjDgKffgdOIyPkrvQC0l_QhYNKxE/edit?usp=sharing">
            here
          </PostLink>
          . If you want to see the code, you can find it in the Google Sheet
        ...
        <P>
          ...
          price per share. This is the only manual input you need to do!{" "}
          <span className="font-bold">
            It's important to note that the other sheets render their data
            through this, so don't mess it up!
          </span>
        </P>
      ...
      <PostContent>
        ...
        <P>
          ...
          perspective and heavily simplifying, this is as close as a bond yield
          as you can get in the world of stocks. {"("}For you finance nerds, I
          know a better metric would most likely be free cash flow yield.{")"}
        </P>
        <P>
          This metric encourages me to hold stocks for as long as possible since
          the EPS yield will only grow larger the longer you hold {"("}as long
          as EPS grows{")"}. For example, at the time of writing, Warren Buffet
          is yielding 50% on his Coca-Cola stock! Imagine paying $1,000 for a
          stock, and making $500 every year 😳.
        </P>
        ...
        <P>
          The green line is your total gains, while the gray line is how much
          the S&P500 would have gained if it bought and sold the same amount of
          money, but into the S&P500. Hopefully your green line is above the
          gray line!
        </P>
        <P>
          You can also see this chart in periods of 1 day, 1 month, YTD, 1 year,
          5 years, and the lifetime chart.
        </P>
        ...
        <P>
          On the right side, you can get an overview of how the best investors
          are moving as a group. It shows you the top 10 buys overall that all
          super investors made in the quarter.
        </P>
        <P>
          You might be wondering, how do I get this data? Most data providers
          would charge an arm and a leg for this information. I simply just
          found a handy dandy website called{" "}
        ...
        <P>
          ...
          starting your investing journey or you're deep into tracking
          performance and analyzing superinvestor moves, I hope this tracker
          helps bring clarity, confidence, and maybe even a bit of excitement to
          your portfolio.
        </P>
        <P>
          If you have ideas for features or improvements, feel free to reach
          out! I’m always looking to make it better. Until then, invest wisely
          and keep that green line above the gray one 📈.
        </P>
      </PostContent>
    </PostWrapper>
  );
